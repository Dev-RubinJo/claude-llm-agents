...
| 에이전트 | 모델 | 사용 시점 |
|---------|------|----------|
| `gemini-pro` | gemini-3.0-pro | 아키텍처 분석, 보안 감사, 복잡한 의존성 분석 |
| `gemini-flash` | gemini-3.0-flash | 기능 확인, 모듈 요약, 컨벤션 파악 |
| `gemini-flash-lite` | gemini-3.0-flash-lite | YES/NO 판단, 단순 확인, 한 줄 요약 |
